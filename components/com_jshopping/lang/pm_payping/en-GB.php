...
define('_JSHOP_PM_PAYPING_Return_URL_TOOLTIP', 'The return url that will be sent to payping gateway to make payment code and refered after return from bank gateway. Note main domain of it should be the same as domain used to take the token and the Alias name of peyment will be added to end of it when sending to payping gateway.');
...
define('_JSHOP_PM_PAYPING_ENDFORM_PAYMENT_PAYMENT_CODE_NOT_MATCH_ERROR', 'Transaction payment code not match to the order data!');
